...
//        HeapGeneric<HeapValue> heap = new HeapGeneric<HeapValue>();
...
//                heap.Add(new HeapValue(connection, connection.Cost(start, properties, ignoreCrouchCost)));
//            }
...
//                HeapValue cur = heap.RemoveFirst();
...
//                    heap.Add(new HeapValue(connection, cur.value + connection.Cost(properties, ignoreCrouchCost)));
//                }
//            }
