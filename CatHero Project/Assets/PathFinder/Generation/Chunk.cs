...
namespace K_PathFinder {
    public struct GeneralDataGrouped : IEquatable<GeneralDataGrouped> {
        public readonly AgentProperties properties;
        public readonly int group;

        public GeneralDataGrouped(AgentProperties Properties, int Group) {
            properties = Properties;
            group = Group;
        }

        public bool Equals(GeneralDataGrouped other) {
            return other == this;
        }

        public override int GetHashCode() {
            return group.GetHashCode() ^ properties.GetHashCode();
        }

        public override bool Equals(object obj) {
            if (!(obj is GeneralDataGrouped))
                return false;

            return (GeneralDataGrouped)obj == this;
        }

        public static bool operator ==(GeneralDataGrouped a, GeneralDataGrouped b) {
            return a.group == b.group && a.properties == b.properties;
        }
    ...
    public struct GeneralXZData : IEquatable<GeneralXZData> {
        ...
        public GeneralXZData(XZPosInt chunkPos, AgentProperties properties) : this(chunkPos.x, chunkPos.z, properties) { }
        ...
        public override int GetHashCode() {    
            return x * 10 + z * 100 ^ properties.GetHashCode();
        }
        ...
        public static bool operator ==(GeneralXZData a, GeneralXZData b) {
            return a.x == b.x && a.z == b.z && ReferenceEquals(a.properties, b.properties);
        }
    ...
    public struct ChunkData {  
        ...
        public YRangeInt heightRange {
            get { return new YRangeInt(min, max); }
        }
        ...
        public override string ToString() {
            return string.Format("x: {0}, z {1}, min: {2}, max: {3}", x, z, min, max);
        }
    }
