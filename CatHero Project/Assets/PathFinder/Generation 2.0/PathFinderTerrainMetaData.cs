    ...
    public class PathFinderTerrainMetaData : MonoBehaviour {
        ...
        public void Refresh() {
            ...
            if (treeInstances.Count > 0) {
                PathFinder.RemoveChunkContent(treeInstances);   
            }           
            ...
            if (treeInstances.Count > 0) {
                PathFinder.ProcessChunkContent(treeInstances);
            }
        ...
        public void GetTreeShapes(NavMeshTemplateCreation template, ref List<ShapeDataAbstract> listToFill) {
            ...
            PathFinder.GetChunkContent(x - 1, z + 1, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x - 1, z, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x - 1, z + 1, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x, z + 1, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x, z, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x, z + 1, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x + 1, z + 1, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x + 1, z, treeInstanceDataHashSet, predicate);
            PathFinder.GetChunkContent(x + 1, z + 1, treeInstanceDataHashSet, predicate);
        ...
        public class TreeInstanceData : IChunkContent {
