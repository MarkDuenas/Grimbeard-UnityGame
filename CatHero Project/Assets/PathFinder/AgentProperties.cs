...
namespace K_PathFinder {
    ...
    public class AgentProperties : ScriptableObject {
        ...
        public float voxelBleed = 0.05f;  //height difference for voxels siutable for bleeding area and passability to higher priority one
        ...
        //sample points
        public bool samplePoints = false;
        public int samplePointsDencity = 5;
        ...
        public int internal_flagList = 0;//1 = patricipated in navmesh generation
        ...
        public static void Create() {
            ...
            ap.ignoredTags = new List<string>();
        ...
        public void OnEnable() {
            PathFinder.AddAgentProperties(this);
        }

        public void OnDestroy() {
            PathFinder.RemoveAgentProperties(this);
        }
    }
}
