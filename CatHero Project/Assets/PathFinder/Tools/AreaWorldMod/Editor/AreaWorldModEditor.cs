...
namespace K_PathFinder {
    [CustomEditor(typeof(AreaWorldMod))][CanEditMultipleObjects]
    public class AreaWorldModEditor : Editor {
        ...
        static string layerString = "_layer";
        ...
        private void OnEnable() {
            ...
            layer = serializedObject.FindProperty(layerString);
        ...
        public void OnSceneGUI() {
            ...
            Quaternion targetRotation = currentTarget.threadSafeRotation;
            Matrix4x4 targetMatrixLocalToWorld = currentTarget.threadSafeLocalToWorldMatrix;
            Matrix4x4 targetMatrixWorldToLocal = currentTarget.ThreadSafeWorldToLocalMatrix;

            Quaternion targetMatrixLocalToWorldRotation = BC.GetRotation(targetMatrixLocalToWorld);
            ...
            for (int i = 0; i < currentTarget.allMods.Count; i++) {
                ...
                Quaternion areaModMatrixRotation = BC.GetRotation(areaModMatrix);
                ...
                switch (current.myType) {
                    case AreaWorldModMagicValueType.Sphere:
                        ...
                        if (editShape) {
                            EditorGUI.BeginChangeCheck();
                            float value = Handles.RadiusHandle(targetMatrixLocalToWorldRotation * areaModMatrixRotation, targetMatrixLocalToWorld.MultiplyPoint(current.position), current.radius);
                            if (EditorGUI.EndChangeCheck()) {
                    ...
                    case AreaWorldModMagicValueType.Capsule:
                        ...
                        if (editShape) {
                            Vector3 discNormals = targetMatrixLocalToWorldRotation * areaModMatrixRotation * new Vector3(0, 1, 0);
                            ...
                            Vector3 posLow = targetMatrixLocalToWorldRotation * areaModMatrixRotation * new Vector3(0, (-current.height * 0.5f) + current.radius, 0);
                            Vector3 posHigh = targetMatrixLocalToWorldRotation * areaModMatrixRotation * new Vector3(0, (current.height * 0.5f) - current.radius, 0);
                            ...
                            vector = Handles.Slider(
                                ...
                                targetMatrixLocalToWorldRotation * areaModMatrixRotation * new Vector3(0, 1, 0), capSize, Handles.DotHandleCap, snap);
                            ...
                            vector = Handles.Slider(
                                ...
                                targetMatrixLocalToWorldRotation * areaModMatrixRotation * new Vector3(1, 0, 0), capSize, Handles.DotHandleCap, snap);
                            vector = areaModMatrixInversed.MultiplyPoint(targetMatrixWorldToLocal.MultiplyPoint(vector));
                            if (EditorGUI.EndChangeCheck()) {
                            ...
                            vector = Handles.Slider(
                                ...
                                targetMatrixLocalToWorldRotation * areaModMatrixRotation * new Vector3(0, 0, 1), capSize, Handles.DotHandleCap, snap);
                            vector = areaModMatrixInversed.MultiplyPoint(targetMatrixWorldToLocal.MultiplyPoint(vector));
                            if (EditorGUI.EndChangeCheck()) {
